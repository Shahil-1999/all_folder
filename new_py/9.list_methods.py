...
#add a list to a list.(Used for concatinate only 2 lists)
colors = ["voilet", "indigo", "blue"]
...
# Concatenating two lists: You can simply concatenate two lists to join two lists.(used for Concatinate 2 or more lists)
colors = ["voilet", "indigo", "blue", "green"]
